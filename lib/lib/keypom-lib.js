...
exports.viewMethod = exports.signAndSendTransactions = exports.isSignedIn = exports.signOut = exports.signIn = exports.getAccount = exports.initConnection = exports.autoSignIn = exports.parseUrl = exports.claimTrialAccount = exports.setLocalStorageKeypomEnv = exports.getLocalStorageKeypomEnv = exports.getEnv = void 0;
...
var keypom_v2_utils_1 = require("./keypom-v2-utils");
...
var KEYPOM_LOCAL_STORAGE_KEY = 'keypom-wallet-selector';
var near, connection, logger, account, accountId, networkId, keyPair, secretKey, publicKey, keypomContractId;
var getEnv = function () {
    return {
        networkId: networkId,
        accountId: accountId,
...
var getLocalStorageKeypomEnv = function () {
    var localStorageAccountId = localStorage.getItem("".concat(KEYPOM_LOCAL_STORAGE_KEY, ":accountId"));
    if (!localStorageAccountId) {
        return;
    }
    accountId = localStorageAccountId;
    networkId = localStorage.getItem("".concat(KEYPOM_LOCAL_STORAGE_KEY, ":networkId"));
    secretKey = localStorage.getItem("".concat(KEYPOM_LOCAL_STORAGE_KEY, ":secretKey"));
    keypomContractId = localStorage.getItem("".concat(KEYPOM_LOCAL_STORAGE_KEY, ":keypomContractId"));
...
var setLocalStorageKeypomEnv = function () {
    localStorage.setItem("".concat(KEYPOM_LOCAL_STORAGE_KEY, ":accountId"), accountId);
    localStorage.setItem("".concat(KEYPOM_LOCAL_STORAGE_KEY, ":networkId"), networkId);
    localStorage.setItem("".concat(KEYPOM_LOCAL_STORAGE_KEY, ":secretKey"), secretKey);
    localStorage.setItem("".concat(KEYPOM_LOCAL_STORAGE_KEY, ":keypomContractId"), keypomContractId);
};
exports.setLocalStorageKeypomEnv = setLocalStorageKeypomEnv;
var claimTrialAccount = function () { return __awaiter(void 0, void 0, void 0, function () {
    var newAccountId;
    return __generator(this, function (_a) {
        newAccountId = "keypom-trial-".concat(Date.now(), ".linkdrop-beta.keypom.testnet");
...
var parseUrl = function () {
    /// TODO validation
    var split = window.location.href.split('/keypom-trial/');
    if (split.length < 2) {
        return false;
    }
    var trialInfo = split[1];
    var _a = trialInfo.split('#'), keypomContractId = _a[0], trialSecretKey = _a[1];
...
var signAndSendTransactions = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var args, transformedTransactions, promises;
...
var viewMethod = function (_a) {
    var contractId = _a.contractId, methodName = _a.methodName, _b = _a.args, args = _b === void 0 ? {} : _b;
    return __awaiter(void 0, void 0, void 0, function () {
        var provider, res;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    provider = new nearAPI.providers.JsonRpcProvider({ url: networks[networkId].nodeUrl });
