...
var claimTrialAccount = function () { return __awaiter(void 0, void 0, void 0, function () {
    var isTrialClaimed, dropInfo, e_1, modal, newAccountId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                ...
                return [3 /*break*/, 4];
            case 4:
                modal = (0, modal_1.setupKeypomModal)({
...
var parseUrl = function (desiredUrl) {
    /// TODO validation
    desiredUrl = desiredUrl || '/keypom-trial/';
    var split = window.location.href.split(desiredUrl);
    if (split.length < 2) {
        return false;
    }
...
var signIn = function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    console.log("i am signing in lol");
