...
exports.viewMethod = exports.signAndSendTransactions = exports.isSignedIn = exports.switchAccount = exports.signOut = exports.signIn = exports.getAccount = exports.initConnection = exports.autoSignIn = exports.parseUrl = exports.claimTrialAccount = exports.setLocalStorageKeypomEnv = exports.getLocalStorageKeypomEnv = exports.getEnv = void 0;
...
var getLocalStorageKeypomEnv = function () {
    var localStorageDataJson = localStorage.getItem("".concat(KEYPOM_LOCAL_STORAGE_KEY, ":envData"));
    if (!localStorageDataJson) {
        return false;
    }
    var localStorageData = JSON.parse(localStorageDataJson);
...
var setLocalStorageKeypomEnv = function () {
    ...
    localStorage.setItem("".concat(KEYPOM_LOCAL_STORAGE_KEY, ":envData"), dataToWrite);
};
...
var claimTrialAccount = function () { return __awaiter(void 0, void 0, void 0, function () {
    var isTrialClaimed, dropInfo, e_1, newAccountId, desiredAccountId, desiredAccountId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                if (!isTrialClaimed) {
                    desiredAccountId = window.prompt("Enter a desired account ID");
                    console.log('desiredAccountId: ', desiredAccountId);
                    newAccountId = "".concat(desiredAccountId, ".linkdrop-beta.keypom.testnet");
                }
                else {
                    desiredAccountId = window.prompt("Enter an existing account", "test-1676298422580");
                    console.log('desiredAccountId: ', desiredAccountId);
                    newAccountId = "".concat(desiredAccountId, ".linkdrop-beta.keypom.testnet");
                }
                console.log('isTrialClaimed: ', isTrialClaimed);
                (0, exports.switchAccount)(newAccountId);
...
var parseUrl = function () {
    ...
    var _a = trialInfo.split('#'), trialKeypomContract = _a[0], trialSecretKey = _a[1];
...
var signOut = function () {
    ...
    localStorage.removeItem("".concat(KEYPOM_LOCAL_STORAGE_KEY, ":envData"));
};
exports.signOut = signOut;
var switchAccount = function (id) {
    logger.log("Keypom:switchAccount");
    accountId = id;
    (0, exports.setLocalStorageKeypomEnv)();
};
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    nodeUrl = networks[networkId].nodeUrl;
