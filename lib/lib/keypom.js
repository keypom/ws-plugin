...
var Keypom = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var envExists, validUrl, isValidActions, transformActions;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    console.log("I AM INITTING KEYPOM?????");
                    (0, keypom_lib_1.initConnection)(options.network, logger);
                    console.log("IM AUTO SIGNING IN");
                    envExists = (0, keypom_lib_1.getLocalStorageKeypomEnv)();
                    validUrl = (0, keypom_lib_1.parseUrl)("/keypom-url/");
                    console.log('validUrl: ', validUrl);
                    console.log('envExists: ', envExists);
                    if (!(validUrl && !envExists)) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, keypom_lib_1.claimTrialAccount)()];
                case 1:
                    _b.sent();
                    (0, keypom_lib_1.autoSignIn)();
                    (0, keypom_lib_1.setLocalStorageKeypomEnv)();
                    _b.label = 2;
                case 2:
                    ...
                    return [2 /*return*/, {
                            get networkId() {
                                var networkId = (0, keypom_lib_1.getEnv)().networkId;
                                return networkId;
                            },
                            account: function () {
                                return __awaiter(this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        ...
                                        account = (0, keypom_lib_1.getEnv)().account;
                            ...
                            switchAccount: function (id) {
                                return __awaiter(this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        (0, keypom_lib_1.switchAccount)(id);
                                        return [2 /*return*/];
                                    });
                                });
                            },
                            getAccountId: function () {
                                return __awaiter(this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        ...
                                        accountId = (0, keypom_lib_1.getEnv)().accountId;
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                ...
                                                return [4 /*yield*/, (0, keypom_lib_1.signIn)()];
                                            case 1:
                                                account = _a.sent();
                                                return [2 /*return*/, [account]];
                                        }
...
function setupKeypom(_a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, _c = _b.iconUrl, iconUrl = _c === void 0 ? icon_1.default : _c, _d = _b.deprecated, deprecated = _d === void 0 ? false : _d, desiredUrl = _b.desiredUrl;
