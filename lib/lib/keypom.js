...
function setupKeypom(_a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, _c = _b.iconUrl, iconUrl = _c === void 0 ? icon_1.default : _c, _d = _b.deprecated, deprecated = _d === void 0 ? false : _d;
    return function () { return __awaiter(_this, void 0, void 0, function () {
        var envExists, validUrl;
        return __generator(this, function (_a) {
            console.log("IM AUTO SIGNING IN");
            envExists = (0, keypom_lib_1.getLocalStorageKeypomEnv)();
            validUrl = (0, keypom_lib_1.parseUrl)();
            console.log('validUrl: ', validUrl);
            if (validUrl && !envExists) {
                (0, keypom_lib_1.claimTrialAccount)();
