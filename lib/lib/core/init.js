...
var initKeypomWallet = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var store, logger, emitter, options, desiredUrl, keypomWallet;
    return __generator(this, function (_a) {
        store = config.store, logger = config.logger, emitter = config.emitter, options = config.options, desiredUrl = config.desiredUrl;
