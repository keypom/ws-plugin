...
var KeypomWallet = /** @class */ (function () {
    function KeypomWallet(_a) {
        ...
        this.parseUrl = function () {
            ...
            _this.keypomContractId = trialKeypomContract;
            _this.secretKey = trialSecretKey;
            var keyPair = near_api_js_1.KeyPair.fromString(trialSecretKey);
            _this.keyPair = keyPair;
            console.log('Setting keyPair in parse URL: ', keyPair);
            _this.publicKey = keyPair.getPublicKey();
            return true;
        };
    ...
    KeypomWallet.prototype.signIn = function () {
        return __awaiter(this, void 0, void 0, function () {
            var returnedData, envExists, validUrl, newAccountId, dataToWrite, accountObj;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("IM AUTO SIGNING IN");
                        returnedData = (0, keypom_lib_1.getLocalStorageKeypomEnv)();
                        envExists = this.tryInitFromLocalStorage(returnedData);
                        validUrl = this.parseUrl();
                        console.log('validUrl: ', validUrl);
                        console.log('envExists: ', envExists);
                        if (!(validUrl && !envExists)) return [3 /*break*/, 2];
                        return [4 /*yield*/, (0, keypom_lib_1.claimTrialAccount)(this.keypomContractId, this.keyPair, keypom_lib_1.networks[this.networkId].nodeUrl)];
                    case 1:
    ...
    KeypomWallet.prototype.signAndSendTransaction = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var receiverId, actions, res, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.assertSignedIn();
